...
function controlBloqueCompaniaAbogadosContrarios() {
	...
	if (document.getElementById('perjudicadoView.swAsegurado').value == valorSi) {
    	perjudicadoIndustrialForm['perjudicadoView.aseguradora.id'].selectedIndex = 0;
    	perjudicadoIndustrialForm['perjudicadoView.aseguradora.id'].onchange();
    	perjudicadoIndustrialForm['perjudicadoView.aseguradoraNombre'].value = "";
    	perjudicadoIndustrialForm['perjudicadoView.contrarioPoliza'].value = "";
    	perjudicadoIndustrialForm['perjudicadoView.contrarioRefExp'].value = "";
    	perjudicadoIndustrialForm['perjudicadoView.swPrepAbogado'].selectedIndex = 0;
    	perjudicadoIndustrialForm['perjudicadoView.swPrepAbogado'].onchange();
    	perjudicadoIndustrialForm['perjudicadoView.nombreAbogado'].value = "";
    	perjudicadoIndustrialForm['perjudicadoView.tfnoAbogado'].value = "";
    	perjudicadoIndustrialForm['perjudicadoView.emailAbogado'].value = "";
		if (perjudicadoIndustrialForm['perjudicadoView.tramitador.id'] != null) {
			perjudicadoIndustrialForm['perjudicadoView.tramitador.id'].selectedIndex = 0;
		}
	}
}
...
function grabar(operacion){
  ...
  var validado = validaForm(document.forms(0),validatePerjudicadoIndustrialForm,'iAreaTrabajo');
