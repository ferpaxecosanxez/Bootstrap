...
function guardarModificacion(){
	...
	var validado = validaForm(document.forms(0),validatePerjudicadoPersonaIndustrialForm,'iAreaTrabajo');
	if(validado){
		muestraCarga();
		submitForm(document.forms(0),null,'iAreaTrabajo');
	}      
...
function reloadEstadoMotivo(){   
    retrieveURLParameterSync(actionReloadEstadoMotivo,'perjudicadoPersonaIndustrialForm','perjudicadoPersonaView.estadoObjeto.id','estadoObjetoAjax'); 
}
